...
users = User.create([{first_name: 'Admin', last_name: 'Admin', email: 'admin@gmail.com',is_admin: true
                         encrypted_password: '$2a$12$uZk2SOjH17gW5k1dVk9BI.hAt22UQcGRoJWKrV365pJZU5.gByJGK'}, # mdp: adminadmin
                        {first_name: 'Toto', last_name: 'toto', email: 'toto@toto.com',is_admin: false
                         encrypted_password: '$2a$12$l9SoaOcSRZzVeqbNunGk3eqdK7vLQ2CML.5ST5TEZNNeWHk3Jmtmq'}, # mdp 000000
...
games = Game.create([{name: 'Elder Scroll 10 : Landersbram', description: 'Une nouvelle terre à découvrir et à dominer.', note: 5.0,
                        datePublished: '2021-01-10', category: categories[0], studio: studios[0], platform: platform[0] },
                     {name: 'Mass Effect 3', description: "L'avenir des races intelligentes est entre les mains du Commandant Shepard.", note: 4.5,
                        datePublished: '2020-07-10', category: categories[0], studio: studios[1], platform: platform[0] },
                        {name: 'Mass Effect 3', description: "L'avenir des races intelligentes est entre les mains du Commandant Shepard.", note: 4.5,
                        datePublished: '2020-07-10', category: categories[0], studio: studios[1], platform: platform[1] },
                        {name: 'Mass Effect 3', description: "L'avenir des races intelligentes est entre les mains du Commandant Shepard.", note: 4.5,
                        datePublished: '2020-07-10', category: categories[0], studio: studios[1], platform: platform[2] },
                        {name: 'Portal Arena', description: "Combatter pour obtenir la gloire de votre espèce dans l'arène de Portal Arena.", note: 5.0,
                        datePublished: '2021-01-15', category: categories[6], studio: studios[5], platform: platform[0] }
                    ]) 
